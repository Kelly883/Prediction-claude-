...
export const metadata = buildMetadata({
  title: 'Serie A Predictions — PredictPro',
  description: 'Get Serie A football predictions with booking codes. Subscribe to PredictPro for verified tips before every matchday.',
  pathname: '/leagues/serie-a',
});
      ...
      <section className="section" style={{ paddingBottom: 56 }}>
        <div className="container">
          ...
          <p style={{ maxWidth: 640, marginTop: 20, fontSize: 17, color: 'var(--chalk-muted)', lineHeight: 1.6 }}>
            Verified predictions for Italy's top division. Subscribe to receive booking codes and analysis before every round of fixtures.
          </p>
