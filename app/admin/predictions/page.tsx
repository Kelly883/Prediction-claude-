  ...
  return (
    <div className="space-y-6 w-full max-w-6xl mx-auto">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full">
          ...
          <Link
            ...
            className="flex items-center justify-between p-3.5 rounded-xl bg-[var(--pitch)] border border-[rgba(243,245,236,0.14)] hover:border-amber-500/40 transition-all text-left text-white no-underline w-full"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-bold text-white">Import CSV</div>
          ...
          <button
            ...
            className="flex items-center justify-between p-3.5 rounded-xl bg-[var(--floodlight)] text-[var(--pitch)] font-bold transition-all hover:bg-[#f3bc20] text-left w-full"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[11px] text-[var(--pitch)]/80">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 w-full">
        <div className="card p-4 bg-[var(--pitch)] border border-[rgba(243,245,236,0.14)] flex items-center gap-3.5 rounded-2xl">
          ...
          <div>
            <div className="text-2xl font-bold text-white leading-none">{totalPosts}</div>
            <div className="text-xs text-[var(--chalk-muted)] font-medium mt-1">Total Predictions</div>
          </div>
        </div>
        ...
        <div className="card p-4 bg-[var(--pitch)] border border-[rgba(243,245,236,0.14)] flex items-center gap-3.5 rounded-2xl">
          ...
          <div>
            <div className="text-2xl font-bold text-emerald-400 leading-none">{publishedPosts}</div>
            <div className="text-xs text-[var(--chalk-muted)] font-medium mt-1">Published Live</div>
          </div>
        </div>
        ...
        <div className="card p-4 bg-[var(--pitch)] border border-[rgba(243,245,236,0.14)] flex items-center gap-3.5 rounded-2xl">
          ...
          <div>
            <div className="text-2xl font-bold text-amber-300 leading-none">{draftPosts}</div>
            <div className="text-xs text-[var(--chalk-muted)] font-medium mt-1">Drafts Pending</div>
          </div>
        </div>
        ...
        <div className="card p-4 bg-[var(--pitch)] border border-[rgba(243,245,236,0.14)] flex items-center gap-3.5 rounded-2xl">
          ...
          <div>
            <div className="text-2xl font-bold text-purple-300 leading-none">{postsWithImages}</div>
            <div className="text-xs text-[var(--chalk-muted)] font-medium mt-1">Image Slip Posts</div>
          </div>
        </div>
      </div>
      ...
      <div className="card p-5 sm:p-7 space-y-5">
        ...
        {loading ? (
          ...
          <div className="py-10 px-4 text-center border border-dashed border-[rgba(243,245,236,0.14)] rounded-2xl flex flex-col items-center justify-center">
            <div style={{ width: '64px', height: '64px' }} className="mb-4 relative flex items-center justify-center mx-auto">
              <svg style={{ width: '64px', height: '64px', maxWidth: '64px', maxHeight: '64px' }} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-sm text-[var(--chalk-muted)] font-medium max-w-md mx-auto leading-relaxed">
