...
export const metadata = buildMetadata({
  title: 'Champions League Predictions — PredictPro',
  description: 'Get Champions League football predictions with booking codes. Subscribe to PredictPro for verified tips.',
  pathname: '/leagues/champions-league',
});
      ...
      <section className="section" style={{ paddingBottom: 56 }}>
        <div className="container">
          ...
          <p style={{ maxWidth: 640, marginTop: 20, fontSize: 17, color: 'var(--chalk-muted)', lineHeight: 1.6 }}>
            Verified predictions for Europe's premier club competition. Subscribe to receive booking codes and analysis before every matchday.
          </p>
