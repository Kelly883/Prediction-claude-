...
export const metadata = buildMetadata({
  title: "Tomorrow's Football Predictions — PredictPro",
  description: 'Preview tomorrow football predictions. Subscribe to unlock full tips with booking codes.',
  pathname: '/predictions/tomorrow',
});
...
export default function TomorrowPredictionsPage() {
  ...
  const sampleMatches = [
    { match: 'Bayern Munich vs Dortmund', prediction: 'Home win', time: '17:30' },
    { match: 'Juventus vs AC Milan', prediction: 'Over 2.5', time: '19:45' },
    { match: 'PSG vs Marseille', prediction: 'Home win', time: '21:00' },
  ];
      ...
      <section className="section" style={{ paddingBottom: 56 }}>
        <div className="container">
          ...
          <p style={{ maxWidth: 600, marginTop: 20, fontSize: 16, color: 'var(--chalk-muted)', lineHeight: 1.6 }}>
            A preview of tomorrow's matches. Subscribe to unlock the full predictions with booking codes.
          </p>
          ...
          <div style={{ marginTop: 32, display: 'flex', gap: 14, flexWrap: 'wrap' }}>
            ...
            <Link href="/predictions/today" className="btn btn-ghost">Today's predictions</Link>
